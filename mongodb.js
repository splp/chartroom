...
collection.insert({'title':"I like cake",
"body":"It is quite good"},{safe:true},function(err, document) {
   if (err) throw err;
...
var _id = new client.bson_serializer.ObjectID('4e6513f0730d31950100001');
